...
-- Textclock
local mytextclock = wibox.widget.textclock(markup.fontfg(theme.font,colors.maroon," ") .. markup(theme.fg_normal," %a %b %d ").. "  " ..markup(colors.lavender," ")..markup(theme.fg_normal, " %H:%M  "))
mytextclock.font = theme.font

-- CPU
local cpuicon = wibox.widget.textbox(markup.fontfg(theme.font, colors.sapphire,'  '))
...
-- Weather
local weathericon = wibox.widget.textbox(markup.fontfg(theme.font,colors.mauve,'  '))
