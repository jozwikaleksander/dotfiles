...
-- }}}
-- Critical notification theme

naughty.config.presets.critical.bg = beautiful.notification_urgent_bg
...
awful.rules.rules = {
    ...
    -- lunarclient
    { rule = {class = "lunarclient"},
    properties = {screen=2, tag="󰊗 ", floating = false, maximized = false}},
...
-- Play startup sound
awful.spawn.with_shell('paplay "$HOME"/.config/awesome/sounds/startup.wav')
